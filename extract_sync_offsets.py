...
# === Environment Variables from postproces.sh ===
episode_id = os.getenv("episode_id")
series_id = os.getenv("series_id")
provider = os.getenv("provider")
subtitle_id = os.getenv("subtitle_id")
subtitles_language = os.getenv("subtitles_language")
subtitles = os.getenv("subtitles")
...
try:
    ...
    if abs(offset) > ALLOWED_OFFSET_SECONDS:
        ...
        print(f"[INFO] Offset is within acceptable range ±{ALLOWED_OFFSET_SECONDS} seconds. No action taken.", flush=True)
